        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-2 sm:p-4 animate-in fade-in duration-200">
            <div className={`bg-[#18181B] text-white w-full ${previewIndex !== null ? 'max-w-4xl' : 'max-w-xl'} rounded-3xl overflow-hidden shadow-2xl border border-neutral-800 flex flex-col relative max-h-[94vh] transition-all duration-300`}>
                ...
                <div ref={contentRef} className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-5">
                    ...
                    {/* Mode 2: Results Display (Grid of all photos found) */}
                    {hasSearched && (
                        <div className="space-y-6">
                            {/* Top Bar with Search Stats & New Search Button */}
            ...
            {/* ─── MODAL DEDICADO DE VISUALIZAÇÃO COM NAVEGAÇÃO LATERAL (LIGHTBOX) ─── */}
            {hasSearched && previewIndex !== null && results[previewIndex] && (() => {
                ...
                return (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/95 backdrop-blur-lg p-2 sm:p-4 animate-in fade-in duration-200">
                        <div className="bg-[#18181B] text-white w-full max-w-4xl rounded-3xl overflow-hidden shadow-2xl border border-neutral-800 flex flex-col relative max-h-[95vh]">
                            
                            {/* Lightbox Top Header */}
                            <div className="p-4 flex items-center justify-between border-b border-neutral-800/80 bg-[#18181B]">
                                <button
                                    onClick={() => setPreviewIndex(null)}
                                    className="flex items-center gap-2 text-xs font-semibold text-neutral-300 hover:text-white bg-neutral-900 hover:bg-neutral-800 px-3.5 py-2 rounded-xl transition-all border border-neutral-800 cursor-pointer shadow"
                                >
                                    <ArrowLeft size={16} />
