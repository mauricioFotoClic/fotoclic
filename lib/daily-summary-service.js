...
export async function generateAndSendDailySummary() {
  ...
  try {
    ...
    const gatewayTotal = totalPhotosSold * 1.00;
    ...
    const topValFormatted = Math.max(0, topPhotographerTotal - (topPhotographerTotal * 0.06) - (totalPhotosSold * 1.00)).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
...
• 💳 *Taxas Gateway Appmax (R$ 1/PIX):* \`- ${gatewayFormatted}\`
